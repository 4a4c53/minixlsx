...
// --- Helpers para construir .xlsx sintéticos de bajo nivel (casos que Workbook no puede producir) ---
...
/** Construye un .xlsx sintético con N hojas vacías, solo para probar validación de nombres. */
function buildXlsxWithSheetNames(names: string[]): Buffer {
	const workbookXml =
